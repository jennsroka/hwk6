...
public:
	...
	/** This function makes the move from the space that was input by the user.
     @param move is a constant string variable that was input by the user.
     @return is void, so there is no return
     **/
